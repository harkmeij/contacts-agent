...
const TOOLS: Anthropic.Tool[] = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        youtube: { type: "string", description: "YouTube channel URL or handle" },
    ...
    switch (name) {
      case "add_contact": {
        const contact = addContact(input.type as ContactType, input.name as string, {
          ...
          youtube: input.youtube as string | undefined,
          tiktok: input.tiktok as string | undefined,
      ...
      case "update_contact": {
        ...
        const updated = updateContact(id, {
          ...
          linkedin: input.linkedin !== undefined ? (input.linkedin as string | null) : undefined,
          twitter: input.twitter !== undefined ? (input.twitter as string | null) : undefined,
          youtube: input.youtube !== undefined ? (input.youtube as string | null) : undefined,
          tiktok: input.tiktok !== undefined ? (input.tiktok as string | null) : undefined,
